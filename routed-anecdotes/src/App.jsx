...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.setNotification(`Anecdote '${content.field.value}' created!`)
    setTimeout(() => {
...
const AnecdoteDetail = ({ anecdotes }) => {
  ...
  if (!anecdote) {
    return <div>Anécdota no encontrada</div>;
  }
  ...
  return (
    <div>
      ...
      <p>For more info, visit <a href={anecdote.info} target="_blank" rel="noopener noreferrer">this link</a></p>
    </div>
  );
}
